...
* Performance: Hardware-agnostic ML-DSA architecture. Devnet validated at ~317k ns (Consumer CPU limit), engineered to scale at    < 100,000 ns on Enterprise Bare-Metal.
